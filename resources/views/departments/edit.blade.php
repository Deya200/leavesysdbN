            ...
            <form method="POST" action="{{ route('departments.update', $department->DepartmentID) }}">
                ...
                <div class="form-section">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h6 class="mb-0 text-primary" style="color: #2E3A87;">Department Information</h6>
                        <span class="department-info-badge">
                    ...
                    <div class="form-group">
                        ...
                        @enderror
                        <div class="form-hint">Enter the official name of the department</div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="SupervisorID" id="SupervisorID" 
                            ...
                            @foreach($supervisors as $supervisor)
                                <option value="{{ $supervisor->EmployeeNumber }}" 
                                    {{ old('SupervisorID', $department->SupervisorID) == $supervisor->EmployeeNumber ? 'selected' : '' }}>
                        ...
                        @error('SupervisorID')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <div class="form-hint">Select an employee to assign as department supervisor</div>
                ...
                <div class="text-center mt-4">
                    ...
                    <a href="{{ route('departments.index') }}" class="btn btn-outline-secondary px-5 ms-2">
