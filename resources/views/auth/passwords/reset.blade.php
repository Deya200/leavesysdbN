                    ...
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input id="email" type="email" class="form-control border-start-0 ps-0 @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autofocus placeholder="name@example.com">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input id="password" type="password" class="form-control border-start-0 ps-0 @error('password') is-invalid @enderror" name="password" required placeholder="At least 8 characters">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input id="password-confirm" type="password" class="form-control border-start-0 ps-0" name="password_confirmation" required placeholder="Repeat new password">
                            </div>
                        </div>
