    ...
    <div class="row justify-content-center">
        <div class="col-lg-10">
            <div class="card shadow-lg overflow-hidden">
                <div class="card-header text-white" style="background: linear-gradient(135deg, #3a7bd5, #00d2ff);">
                    ...
                    <form method="POST" action="{{ route('leave_requests.store') }}" class="needs-validation" novalidate>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <label class="btn btn-outline-primary w-100 py-3 d-flex flex-column"
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary btn-lg px-4 py-3 shadow-sm"
                                    style="background: linear-gradient(135deg, #3a7bd5, #00d2ff); border: none;">
