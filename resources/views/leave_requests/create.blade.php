            ...
            <div class="col-lg-12">
                <div class="card shadow-lg overflow-hidden">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="{{ route('leave_requests.review') }}" class="needs-validation"
                            novalidate>
                            @csrf
                            ...
                            <div class="mb-4">
                                ...
                                <select id="LeaveTypeID" name="LeaveTypeID" class="form-select form-select-lg" required>
                                    <option value="" disabled {{ old('LeaveTypeID') ? '' : 'selected' }}>-- Select Leave
                                        Type --</option>
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control" id="EndDate" name="EndDate"
                                            value="{{ old('EndDate') }}" min="{{ date('Y-m-d') }}" required>
                                    </div>
                                    @error('EndDate')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
