...
@section('title', 'Employee Locum Sessions - Admin')
...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.locum.index') }}" class="btn btn-outline-secondary">
            <i class="fas fa-arrow-left me-2"></i>Back to Admin Locum Management
        </a>
    </div>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100 bg-primary bg-opacity-10">
                <div class="card-body text-center">
                    ...
                    <h3 class="fw-bold text-primary mb-0">{{ $locumSessions->count() }}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100 bg-success bg-opacity-10">
                <div class="card-body text-center">
                    ...
                    <h3 class="fw-bold text-success mb-0">{{ number_format($locumSessions->sum('hours_worked'), 2) }}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            ...
            @if($locumSessions->isNotEmpty())
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            @foreach($locumSessions as $session)
                                <tr>
